...
def Online_BURST_GEN_KMeans(data,distance_measure="euclidean",transformation="default",**params):
    slide=len(data[0])
    baseline=Kmeans
    clf = BURST_GEN(baseline,slide,k=None,distance_measure=distance_measure,transformation=transformation,verbose=False,**params)
    eval_metrics = apply_online_clustering(data, clf)
    return eval_metrics
...
def Online_BURSTK_GEN_KMeans(data,k,distance_measure="euclidean",transformation="default",**params):
    slide=len(data[0])
    baseline=Kmeans
    clf = BURST_GEN(baseline,slide,k=k,distance_measure=distance_measure,transformation=transformation,verbose=False,**params)
    eval_metrics = apply_online_clustering(data, clf)
    return eval_metrics
...
Need_K=["KShapes","Kmeans","Kmedoids","DTC","MiniBatchKMeans","STREAMLS","Clustream","BirchK","BURSTK","BURSTK_GEN_KMeans","BURSTK_GEN_KMedoids"]
...
Parameters={
    ...
    "DenStream":{'decaying_factor': 0.01, 'beta': 1, 'mu_factor': 5, 'epsilon': 1,"distance_measure":"euclidean","transformation":"default"},
    ...
    "DbStream":{"fading_factor":0.05,"cleanup_interval":0.8,"intersection_factor":0.2,"clustering_threshold":1.5,"minimum_weight":1,"distance_measure":"euclidean","transformation":"catch22"},
    ...
    "BURST":{"alpha":0.3,"distance_measure":"euclidean","transformation":"default"},
    "BURSTK":{"alpha":0.3,"distance_measure":"euclidean","transformation":"default"},
